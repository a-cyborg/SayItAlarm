...
fun SayItAlarmTheme(
    ...
    // Set StatusBar's background color to Transparent.
...
//    val backgroundColor = BackgroundColor(colorScheme.background)
    // Composition locals
...
/* Original code to set Statusbar color.
//    if (!view.isInEditMode) {
//        SideEffect {
...
private val DarkColorScheme = darkColorScheme(
    ...
    onSecondary = Color(0xff458588),
    background = Color(0xff282828),
    primaryContainer = Color(0xff458588),
    surface = Color(0xffa89984),
    onPrimary = Color(0xffb16286),
    onSecondaryContainer = Color(0xff689d6a),
    /*
    primary = Color.White,
